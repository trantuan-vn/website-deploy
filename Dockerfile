...
# Reach Mongo from the build container via host.docker.internal (Mac/Win Docker Desktop)
# or host port-forward: kubectl port-forward -n website svc/mongo 27017:27017
RUN \
